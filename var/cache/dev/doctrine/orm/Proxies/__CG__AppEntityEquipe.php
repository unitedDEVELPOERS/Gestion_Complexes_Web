...
class Equipe extends \App\Entity\Equipe implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Equipe' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Equipe' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Equipe' . "\0" . 'nbreJoueur', '' . "\0" . 'App\\Entity\\Equipe' . "\0" . 'logo', '' . "\0" . 'App\\Entity\\Equipe' . "\0" . 'capitain'];
        }
    ...
    public function setNbreJoueur(int $nbreJoueur): void
    {
        ...
        parent::setNbreJoueur($nbreJoueur);
    }
