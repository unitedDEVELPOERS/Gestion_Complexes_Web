...
class Utilisateur extends \App\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'password', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'role', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'categorie', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'raisonSociale', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'matriculeFiscale', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'verifie', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'soldePoint', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'position', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'telephone', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'positionEquipe', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'equipe'];
        }
